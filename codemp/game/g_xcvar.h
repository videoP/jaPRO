...
XCVAR_DEF( bg_podracerPhysics,			"0",			NULL,				CVAR_SYSTEMINFO,								qtrue )
...
XCVAR_DEF( g_splashDamageScale,			"1",			NULL,				CVAR_ARCHIVE,									qtrue )
...
XCVAR_DEF( g_gunGame,					"0",			CVU_GunGame,		CVAR_ARCHIVE,									qtrue )
...
XCVAR_DEF(g_unlaggedProjectileTolerance,"135",			CVU_Unlagged,		CVAR_ARCHIVE,									qtrue )
...
XCVAR_DEF( g_newVehicleDamageScale,		"0",			NULL,				CVAR_ARCHIVE,									qtrue )
