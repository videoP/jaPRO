...
XCVAR_DEF( cg_movementKeysWalk,		"0",	NULL,					CVAR_ARCHIVE )
...
XCVAR_DEF( cg_killSounds,						"2",	NULL,								CVAR_ARCHIVE )
...
XCVAR_DEF( bg_podracerPhysics,					"0",					NULL,					CVAR_SYSTEMINFO )
...
XCVAR_DEF( cg_drawPodPhysics,					"0",					NULL,					CVAR_ARCHIVE )
XCVAR_DEF( cg_podEnginePitch,					"1.6",					NULL,					CVAR_ARCHIVE )
...
XCVAR_DEF(cg_snapHudRgba1, 						"127 179 230 179", 		CG_SnapHUDColorChange, 		CVAR_ARCHIVE )
XCVAR_DEF(cg_snapHudRgba2, 						"127 127 127 38", 		CG_SnapHUDColorChange, 		CVAR_ARCHIVE )
XCVAR_DEF(cg_snapHudY, 							"235", 					NULL, 						CVAR_ARCHIVE )
XCVAR_DEF(cg_snapHudHeight, 					"5", 					NULL, 						CVAR_ARCHIVE )
